...
namespace Microsoft.eShopWeb.ApplicationCore.Services
{
    public class BasketService : IBasketService
    {
        ...
        public BasketService(IAsyncRepository<Basket> basketRepository,
            IAppLogger<BasketService> logger, IAsyncRepository<CatalogItem> catalogItemRepository)
        {
        ...
        public async Task UpdateBasket(int basketId)
        {
            var basket = await _basketRepository.GetByIdAsync(basketId);
        ...
        public async Task SetQuantities(int basketId, Dictionary<string, int> quantities)
        {
            ...
            foreach (var item in basket.Items)
            {
                ...
                {
                    var availableUnits = _catalogItemRepository.GetByIdAsync(item.CatalogItemId).Result.UnitsInStock;
