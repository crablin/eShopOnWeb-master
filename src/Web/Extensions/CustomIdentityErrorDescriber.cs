...
namespace Microsoft.eShopWeb.Web.Extensions
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"Имя пользователя '{userName}' неверно, может содержать только латинские буквы или цифры." }; }
        ...
        public override IdentityError PasswordRequiresLower() { return new IdentityError { Code = nameof(PasswordRequiresLower), Description = "Пароль должен содержать как минимум один латинский символ в нижнем регистре." }; }
        public override IdentityError PasswordRequiresUpper() { return new IdentityError { Code = nameof(PasswordRequiresUpper), Description = "Пароль должен содержать как минимум один латинский символ в верхнем регистре." }; }
    }
}
